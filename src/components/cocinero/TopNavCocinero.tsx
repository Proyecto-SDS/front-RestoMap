...
interface TopNavCocineroProps {
  empresa: Empresa | null;
}

export function TopNavCocinero({ empresa }: TopNavCocineroProps) {
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[#94A3B8]">Panel de Cocina</p>
          </div>
        </div>
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          >
            ...
            <div className="hidden sm:block text-left">
              <p className="text-xs text-[#334155]">Cocinero</p>
              <p className="text-xs text-[#94A3B8]">Cocina</p>
            </div>
            <ChevronDown
              size={16}
          ...
          {showDropdown && (
            <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-[#E2E8F0] py-2">
              <div className="px-4 py-2 border-b border-[#E2E8F0]">
                ...
                <p className="text-sm text-[#334155]">Cocinero</p>
              </div>
              <button
